...
- **My favourite works**:
  + 🌕 **Flowjomojo**: a ReactFlow-based web-app for modules drag-and-drop to generate Nextflow pipeline. This is a project I'm contributing for st.Jude's BioHackathon.
